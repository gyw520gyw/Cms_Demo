...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-nav side-nav nav_list">
     ...
     <!-- <li>
      ...
      <?php if(is_array($navs)): $i = 0; $__LIST__ = $navs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?><li <?php echo (getActive($nav["c"])); ?>>
          <a href="<?php echo (getAdminMenuUrl($nav)); ?>"><i class="fa fa-fw fa-bar-chart-i"></i><?php echo ($nav["name"]); ?></a>
  ...
  <!-- /.navbar-collapse -->
    ...
    <div class="container-fluid" >
        ...
        <div>
            <button  id="button-add" type="button" class="btn btn-primary dropdown-toggle"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>添加 </button>
            <button  id="button-listorder" type="button" class="btn btn-primary dropdown-toggle"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span>更新排序 </button>
        </div>
