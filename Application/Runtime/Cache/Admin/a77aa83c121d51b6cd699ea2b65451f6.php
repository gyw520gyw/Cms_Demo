  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav side-nav nav_list">
      ...
      <?php if(is_array($navs)): $i = 0; $__LIST__ = $navs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?><li>
          <a href="/admin.php?c=<?php echo ($nav["c"]); ?>"><i class="fa fa-fw fa-bar-chart-o"></i><?php echo ($nav["name"]); ?></a>
            ...
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="singcms-form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="name" value="<?php echo ($menuData["name"]); ?>" class="form-control" id="inputname" placeholder="请填写菜单名" >
                        </div>
                    </div>
                    <!--<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="radio" name="type" id="optionsRadiosInline1" value="1" <?php if($menuData["type"] == 1): ?>checked<?php endif; ?>> 后台菜单
                            <input type="radio" name="type" id="optionsRadiosInline2" value="0" <?php if($menuData["type"] == 0): ?>checked<?php endif; ?>> 前端栏目
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="m" value="<?php echo ($menuData["m"]); ?>" id="inputPassword3" placeholder="模块名如admin">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">控制器:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="c" value="<?php echo ($menuData["c"]); ?>" id="inputPassword3" placeholder="控制器如index">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">方法:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="f" value="<?php echo ($menuData["c"]); ?>" id="inputPassword3" placeholder="方法名如index">
                        </div>
                    </div>
                    <!--<div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="radio" name="status" id="optionsRadiosInline1" value="1" <?php if($menuData["type"] == 1): ?>checked<?php endif; ?>> 开启
                            <input type="radio" name="status" id="optionsRadiosInline2" value="0" <?php if($menuData["type"] == 0): ?>checked<?php endif; ?>> 关闭
                        </div>
